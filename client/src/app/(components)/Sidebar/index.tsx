...
const SidebarContent = ({
  ...
  const sections = user
    ...
    ? filterNavSections((href) => canAccessRoute(user.role, href))

    : [];

  const inventoryUnitCount = items.reduce((sum, item) => sum + item.stock, 0);

  const salesCount = analytics?.stats.totalSales ?? 0;
                ...
                {badge !== undefined && (
                  ...
                  <span
                    ...
                    style={{
                      ...
                      background: isActive ? "rgb(37 99 235 / 0.35)" : "rgb(255 255 255 / 0.1)",
