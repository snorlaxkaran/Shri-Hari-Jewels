...
import CustomerDepartmentsTab from "@/app/(components)/CustomerDetailPanel/CustomerDepartmentsTab";
import {
            ...
            {detail && (
              <>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {detail.companyName && (
                        <p className="text-xs text-zinc-500">{detail.companyName}</p>
                      )}
                ...
                {activeTab === "departments" && (
                  <CustomerDepartmentsTab customerId={detail.id} />
                )}
                  ...
                  <>
                    ...
                    <dl className="grid grid-cols-2 gap-3 text-sm">
                      {[
                        ...
                        ["Contact Person", detail.contactPersonName ?? "—"],
                        ["Email", detail.email ?? "—"],
                      ...
                      <div>
                        <dt className="text-xs text-zinc-400 mb-1">Customer Type</dt>
                        <dd>
                          <CustomerTypeBadge type={detail.customerType} />
                        </dd>
                      </div>
                    </dl>
